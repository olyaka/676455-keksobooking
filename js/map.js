...
var renderPin = function (notice) {
  ...
  var pinX = notice.location.x + 20;
  var pinY = notice.location.y + 40;
...
var renderCard = function (notice) {
  ...
  // cardTemplate.querySelector('.popup__features').appendChild = notice.offer.address;
  cardTemplate.querySelector('.popup__description').textContent = notice.offer.description;

  var featureElementTemplate = document.querySelector('li');
  ...
  var photoElementTemplate = document.querySelector('template').content.querySelector('.popup__photos img');
  var photoFragment = document.createDocumentFragment();

  for (i = 0; i < notice.offer.photos.length; i++) {
...
fragment1.appendChild(renderCard(notices[1]));
cardElement.appendChild(fragment1);
